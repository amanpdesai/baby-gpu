...
module tb_programmable_core_offset_fill;
    ...
    localparam int RECT_WIDTH = 1;
    localparam int RECT_HEIGHT = 1;
    ...
    initial begin
        ...
        mem_read_expect(FRAMEBUFFER_BASE + 32'd0, 32'hAAAA_AAAA);
        mem_read_expect(FRAMEBUFFER_BASE + 32'd4, 32'hBBBB_BBBB);
        mem_read_expect(FRAMEBUFFER_BASE + 32'd8, {FILL_COLOR, 16'hCCCC});
        ...
        $display("tb_programmable_core_offset_fill PASS");
        $finish;
    end
endmodule
