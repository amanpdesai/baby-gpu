...
module tb_programmable_core_bounded_fill;
    ...
    task automatic load_bounded_fill_program;
        begin
            ...
            write_imem(8'd10, isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd9, 4'd0, 18'(FILL_WIDTH)));
            write_imem(8'd11, isa_pkg::isa_cmp_type(4'd10, 4'd4, 4'd9, ISA_CMP_LTU));
            write_imem(8'd12, isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd11, 4'd0, 18'(FILL_HEIGHT)));
            write_imem(8'd13, isa_pkg::isa_cmp_type(4'd12, 4'd1, 4'd11, ISA_CMP_LTU));
            write_imem(8'd14, isa_pkg::isa_r_type(ISA_OP_AND, 4'd13, 4'd10, 4'd12));
            write_imem(8'd15, isa_pkg::isa_p_type(ISA_OP_PSTORE16, 4'd8, 4'd7, 4'd13, 14'd0));
            write_imem(8'd16, isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0));
        end
    endtask
