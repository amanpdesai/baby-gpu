...
module tb_programmable_core_bounded_fill;
    ...
    task automatic load_bounded_fill_program;
        begin
            ...
            write_imem(8'd10, kgpu_movi(4'd9, 18'(FILL_WIDTH)));
            write_imem(8'd11, kgpu_cmp(4'd10, 4'd4, 4'd9, ISA_CMP_LTU));
            write_imem(8'd12, kgpu_movi(4'd11, 18'(FILL_HEIGHT)));
            write_imem(8'd13, kgpu_cmp(4'd12, 4'd1, 4'd11, ISA_CMP_LTU));
            write_imem(8'd14, kgpu_and(4'd13, 4'd10, 4'd12));
            write_imem(8'd15, kgpu_pstore16(4'd8, 4'd7, 4'd13, 14'd0));
            write_imem(8'd16, kgpu_end());
        end
    endtask
