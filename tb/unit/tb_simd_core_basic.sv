...
module tb_simd_core_basic;
  ...
  initial begin
    ...
    reset = 1'b0;
    clear_program();
    imem[0] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd1, 4'd0, 18'd1);
    imem[1] = isa_pkg::isa_b_type(ISA_OP_BRA, 4'd1, 22'd2);
    imem[2] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd2, 4'd0, 18'd11);
    imem[3] = isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0);
    imem[4] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd2, 4'd0, 18'd22);
    imem[5] = isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0);
    pulse_start();
    wait_done();
    check(done && !core_error, "convergent taken branch completes without error");
    debug_read_addr = 4'd2;
    #1;
    expect_all_lanes(32'd22, "taken branch updates PC relative to next instruction");

    reset = 1'b1;
    step();
    reset = 1'b0;
    clear_program();
    imem[0] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd1, 4'd0, 18'd0);
    imem[1] = isa_pkg::isa_b_type(ISA_OP_BRA, 4'd1, 22'd2);
    imem[2] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd2, 4'd0, 18'd11);
    imem[3] = isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0);
    imem[4] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd2, 4'd0, 18'd22);
    ...
    pulse_start();
    wait_done();
    check(done && !core_error, "convergent not-taken branch completes without error");
    debug_read_addr = 4'd2;
    #1;
    expect_all_lanes(32'd11, "not-taken branch falls through");
    ...
    clear_program();
    imem[0] = isa_pkg::isa_s_type(ISA_OP_MOVSR, 4'd1, ISA_SR_LANE_ID);
    imem[1] = isa_pkg::isa_b_type(ISA_OP_BRA, 4'd1, 22'd1);
    imem[2] = isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0);
    pulse_start();
    wait_done();
    check(core_error && !done, "divergent branch drives core error");

    reset = 1'b1;
    step();
    reset = 1'b0;
    clear_program();
    imem[0] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd1, 4'd0, 18'd2);
    imem[1] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd2, 4'd0, 18'd0);
    imem[2] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd3, 4'd0, 18'd1);
    imem[3] = isa_pkg::isa_r_type(ISA_OP_ADD, 4'd2, 4'd2, 4'd3);
    imem[4] = isa_pkg::isa_r_type(ISA_OP_SUB, 4'd1, 4'd1, 4'd3);
    imem[5] = isa_pkg::isa_b_type(ISA_OP_BRA, 4'd1, 22'h3f_fffd);
    imem[6] = isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0);
    pulse_start();
    wait_done();
    check(done && !core_error, "negative-offset branch loop completes without error");
    debug_read_addr = 4'd2;
    #1;
    expect_all_lanes(32'd2, "negative-offset branch loops back relative to next PC");
    ...
    clear_program();
    imem[0] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd1, 4'd0, 18'd5);
    imem[1] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd2, 4'd0, 18'd5);
    imem[2] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd3, 4'd0, 18'd7);
    imem[3] = isa_pkg::isa_cmp_type(4'd4, 4'd1, 4'd2, ISA_CMP_EQ);
    imem[4] = isa_pkg::isa_cmp_type(4'd5, 4'd1, 4'd3, ISA_CMP_NE);
    imem[5] = isa_pkg::isa_cmp_type(4'd6, 4'd1, 4'd3, ISA_CMP_LTU);
    imem[6] = isa_pkg::isa_cmp_type(4'd7, 4'd3, 4'd1, ISA_CMP_GEU);
    imem[7] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd8, 4'd0, 18'd0);
    imem[8] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd9, 4'd0, 18'd1);
    imem[9] = isa_pkg::isa_r_type(ISA_OP_SUB, 4'd8, 4'd8, 4'd9);
    imem[10] = isa_pkg::isa_cmp_type(4'd10, 4'd8, 4'd9, ISA_CMP_LTS);
    imem[11] = isa_pkg::isa_cmp_type(4'd11, 4'd1, 4'd8, ISA_CMP_GES);
    imem[12] = isa_pkg::isa_cmp_type(4'd12, 4'd1, 4'd3, ISA_CMP_EQ);
    imem[13] = isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0);
    pulse_start();
    wait_done();
    check(done && !core_error, "CMP condition program completes without error");
    debug_read_addr = 4'd4;
    #1;
    expect_all_lanes(32'd1, "CMP EQ true result is visible");
    debug_read_addr = 4'd5;
    #1;
    expect_all_lanes(32'd1, "CMP NE true result is visible");
    debug_read_addr = 4'd6;
    #1;
    expect_all_lanes(32'd1, "CMP LTU true result is visible");
    debug_read_addr = 4'd7;
    #1;
    expect_all_lanes(32'd1, "CMP GEU true result is visible");
    debug_read_addr = 4'd10;
    #1;
    expect_all_lanes(32'd1, "CMP LTS true result is visible");
    debug_read_addr = 4'd11;
    #1;
    expect_all_lanes(32'd1, "CMP GES true result is visible");
    debug_read_addr = 4'd12;
    #1;
    expect_all_lanes(32'd0, "CMP false result is visible");
    ...
    imem[3] = isa_pkg::isa_b_type(ISA_OP_BRA, 4'd3, 22'd2);
    imem[4] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd4, 4'd0, 18'd11);
    imem[5] = isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0);
    imem[6] = isa_pkg::isa_i_type(ISA_OP_MOVI, 4'd4, 4'd0, 18'd22);
    imem[7] = isa_pkg::isa_r_type(ISA_OP_END, 4'd0, 4'd0, 4'd0);
    pulse_start();
    wait_done();
    check(done && !core_error, "CMP-fed branch completes without error");
    debug_read_addr = 4'd4;
    #1;
    expect_all_lanes(32'd22, "CMP result feeds BRA predicate");
    ...
    pulse_start();
    wait_done();
    check(done && !core_error, "inactive branch lanes do not force divergence");
    debug_read_addr = 4'd2;
    #1;
    expect_lane_value(0, 32'd22, "partial-mask active lane 0 follows taken branch");
    expect_lane_value(1, 32'd22, "partial-mask active lane 1 follows taken branch");
    expect_lane_value(2, 32'd0, "partial-mask inactive lane 2 stays unchanged");
    expect_lane_value(3, 32'd0, "partial-mask inactive lane 3 stays unchanged");
    launch_active_mask = '1;
