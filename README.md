...
portable video timing, test-pattern, pixel-FIFO, framebuffer-source, stream-mux, video-controller, simulation video-system, framebuffer scanout, and double-buffer swap-control coverage, arbiter-backed `gpu_core` memory
