module memory_arbiter_rr_formal(
    input logic clk
);
    ...
    always_ff @(posedge clk) begin
        if (past_valid && rst_n) begin
            ...
            if (client_req_valid == 3'b001) begin
            ...
            if (client_req_valid == 3'b010) begin
            ...
            if (client_req_valid == 3'b100) begin
            ...
            if (mem_req_valid && mem_req_ready) begin
                assert(client_req_ready != 3'b000);
            end

            if (mem_rsp_valid && rsp_source < CLIENTS) begin
                assert(client_rsp_valid == (3'b001 << rsp_source));
            ...
            if (
                $past(rst_n) &&
                $past(client_req_valid == 3'b111) &&
                $past(mem_req_ready) &&
                $past(mem_req_valid) &&
                $past(grant_source == 2'd0) &&
                client_req_valid == 3'b111 &&
                mem_req_ready &&
                mem_req_valid
            ) begin
